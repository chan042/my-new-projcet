...
TopMemo는 macOS 메뉴 막대에서 팝오버로 사용하는 메모 앱입니다. 상단 아이콘을 클릭하거나 단축키를 누르면 팝오버가 열리고, 바로 타이핑을 시작할 수 있습니다. 무거운 문서 앱을 열지 않고도 아이디어, 할 일, 임시 메모를 빠르게 남기고 다시 꺼내 쓰는 흐름에 집중했습니다.
